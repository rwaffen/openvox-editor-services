...
module PuppetLanguageServer
  ...
  def self.init_puppet(options)
    ...
    raise("Detected OpenVox #{Puppet.version} however the Language Server requires OpenVox 8.0 and above") if Gem::Version.new(Puppet.version) < Gem::Version.new('8.0.0')
